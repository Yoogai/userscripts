...
replace_once('// @version      3.1.9', '// @version      3.1.10', 'metadata version')
replace_once("console.log('[Почта Адыгеи Redesign v3.1.9] Скрипт инициализирован');", "console.log('[Почта Адыгеи Redesign v3.1.10] Скрипт инициализирован');", 'console version')

css_marker = '      html.ady-redesign #rl-right .btn-group-last { order: 2 !important; }'
css_patch = '''      html.ady-redesign #rl-right > div.rl-view-model.RL-SystemDropDown > .b-system-drop-down > .btn-toolbar {
...
'''
replace_once(css_marker, css_patch + css_marker, 'toolbar CSS marker')

js_marker = '''  function normalizeComposeButton() {
...
'''
js_patch = r'''  let copyToastTimer = 0;
...
'''
replace_once(js_marker, js_patch + js_marker, 'toolbar JS marker')
replace_once('''    applyState();
